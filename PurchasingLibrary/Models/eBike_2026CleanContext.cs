    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Part>(entity =>
        {
            ...
            entity.Property(e => e.Description)
                ...
                .HasMaxLength(40)
                .IsUnicode(false);
            entity.Property(e => e.Discontinued).HasAnnotation("Relational:DefaultConstraintName", "DF_Part_Discontinued");
            ...
            entity.Property(e => e.Refundable)
                ...
                .HasDefaultValue("Y")
                .IsFixedLength()
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Parts_Refundable");
        ...
        modelBuilder.Entity<PurchaseOrder>(entity =>
        {
            ...
            entity.Property(e => e.Closed).HasAnnotation("Relational:DefaultConstraintName", "DF_PurchaseOrder_Closed");
            ...
            entity.Property(e => e.RemoveFromViewFlag).HasAnnotation("Relational:DefaultConstraintName", "DF_PurchaseOrder_RemoveFromViewFlag");
        ...
        modelBuilder.Entity<PurchaseOrderDetail>(entity =>
        {
            ...
            entity.Property(e => e.RemoveFromViewFlag).HasAnnotation("Relational:DefaultConstraintName", "DF_PurchaseOrderDetail_RemoveFromViewFlag");
        ...
        modelBuilder.Entity<UnorderedPurchaseItemCart>(entity =>
        {
            ...
            entity.Property(e => e.RemoveFromViewFlag).HasAnnotation("Relational:DefaultConstraintName", "D_UnorderedPurchaseItemCart_RemoveFromViewFlag");
        ...
        modelBuilder.Entity<Vendor>(entity =>
        {
            ...
            entity.Property(e => e.ProvinceId)
                ...
                .HasDefaultValue("AB")
                .IsFixedLength()
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Vendor_ProvinceID")
                .HasColumnName("ProvinceID");
            entity.Property(e => e.RemoveFromViewFlag).HasAnnotation("Relational:DefaultConstraintName", "DF_Vendor_RemoveFromViewFlag");
